...
This directory belongs to `minillm-from-scratch`; the Git root is one level above it.

## Project documentation

- [`../README.md`](../README.md): project overview, setup, data, training, evaluation, and demo commands.
...
- [`../papers/references_and_analysis.md`](../papers/references_and_analysis.md): paper catalog, design-to-code map, and BibTeX.
- `../papers/*.pdf`: local source papers for offline reading; ignored by Git.

## Local experiment artifacts

- `../results/`: reports, JSON/CSV metrics, and generated samples.
