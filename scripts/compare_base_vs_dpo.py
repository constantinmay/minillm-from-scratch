"""Compare v3 base vs DPO checkpoints."""
import sys, os
...
checkpoints = [
    ...
    ("DPO-100", "checkpoints_v3/dpo_step_100.pt"),
    ("DPO-200", "checkpoints_v3/dpo_step_200.pt"),
    ("DPO-300", "checkpoints_v3/dpo_step_300.pt"),
    ("DPO-400", "checkpoints_v3/dpo_step_400.pt"),
    ("DPO-500", "checkpoints_v3/dpo_step_500.pt"),
    ("DPO-final", "checkpoints_v3/dpo.pt"),
]
