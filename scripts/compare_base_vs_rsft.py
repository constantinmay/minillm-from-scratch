"""Compare v3 base vs RSFT checkpoints."""
import sys, os
...
checkpoints = [
    ...
    ("RSFT-25", "checkpoints_v3/sft_step_25.pt"),
    ("RSFT-50", "checkpoints_v3/sft_step_50.pt"),
    ("RSFT-75", "checkpoints_v3/sft_step_75.pt"),
    ("RSFT-100", "checkpoints_v3/sft_step_100.pt"),
