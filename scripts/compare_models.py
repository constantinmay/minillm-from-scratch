"""Compare all v3 models: BASE / SFT v2 / DPO v2 / RSFT."""
import sys, os
...
checkpoints = [
    ...
    ("SFT-v2-25", "checkpoints_v3/sft_step_25.pt"),
    ("SFT-v2-50", "checkpoints_v3/sft_step_50.pt"),
    ("SFT-v2-75", "checkpoints_v3/sft_step_75.pt"),
    ("SFT-v2-100", "checkpoints_v3/sft_step_100.pt"),
    ("SFT-v2-final", "checkpoints_v3/sft_v2.pt"),
    ("DPO-v2-50", "checkpoints_v3/dpo_step_50.pt"),
    ("DPO-v2-100", "checkpoints_v3/dpo_step_100.pt"),
    ("DPO-v2-150", "checkpoints_v3/dpo_step_150.pt"),
    ("DPO-v2-200", "checkpoints_v3/dpo_step_200.pt"),
    ("DPO-v2-final", "checkpoints_v3/dpo_v2.pt"),
    ("RSFT-final", "checkpoints_v3/rsft.pt"),
]
